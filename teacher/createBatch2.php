...
<body>
<!-- Sidebar -->
<!-- // side bar code needs to be added -->
...
<form class="text-center border border-light p-5" action="createBatch2.php"  method = "post">
    ...
    <!-- Degree Name -->
    <input type="text" id="defaultRegisterDegreeName" class="form-control" placeholder="Degree Name" aria-describedby="defaultRegisterFormDegreeNameHelpBlock" name = "degree">
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!-- Start Year -->
            <input type="text" id="defaultRegisterFormStartYear" class="form-control" placeholder="Star Year" name = "startYear">
...
<!--            </div>-->
        ...
        <div class="col">
            <!-- End Year -->
            <input type="text" id="defaultRegisterFormEndYear" class="form-control" placeholder="End Year" name = "endYear">
...
<!--            </div>-->
    ...
    <!-- Submit button -->
    <button class="btn btn-info my-4 btn-block" type="submit" name = "registerBatch" id = "registerBatch">Submit</button>
